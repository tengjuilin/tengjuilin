...
|:keyboard:|[Intro to Scientific Computing](https://github.com/tengjuilin/intro-sci-computing)|AMATH 301|Intro to scientific computing and numerical methods with engineering applications.|
...
|:heart:|Project|For|Description|
|:-:|---|:---:|-|
|:computer:|[Personal Website](https://tengjuilin.netlify.app/)|Myself|Personal website with blog posts, news, resources, and CV. Archives pervious content and page designs.|
|:page_facing_up:|[Markdown Resume](https://github.com/tengjuilin/markdown-resume/blob/main/source/resume.pdf)|Myself|A simple, elegant, and fast workflow to write resumes and CVs in Markdown.|
